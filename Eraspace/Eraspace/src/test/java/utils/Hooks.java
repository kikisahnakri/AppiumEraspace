...
public class Hooks {
    ...
    public void setUp() throws MalformedURLException {
        ...
        caps.setCapability("platformVersion", "12");  // Sesuaikan dengan versi Android Anda
        caps.setCapability("deviceName", "48e03f58");  // Sesuaikan dengan nama perangkat atau ID emulator Anda
